...
export const fbmValueNoiseNodeSpec: NodeSpec = {
  id: 'fbm-value-noise',
  category: 'Patterns',
...
`,
  ...
  float fbmValueTime = ($time + $param.fbmValueTimeOffset) * $param.fbmValueTimeSpeed;
  int octaves = int($param.fbmValueOctaves);
  float feed = fbm2_standard(fbmUV, fbmValueTime, $param.fbmValueScale, octaves, $param.fbmValueLacunarity, $param.fbmValueGain);
